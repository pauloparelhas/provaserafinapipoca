...
def status_artefatos(nb):
    ...
    'completed' se existir; senao, o mais recente por created_at. (bug real
    achado 18/08 na copia AP2 deste script: pegar o ULTIMO da lista escondia
    um 'completed' atras de um 'failed' mais novo na resposta da API.)"""
