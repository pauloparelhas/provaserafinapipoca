/* ============================================================
   SERA_THEME.JS — Seletor de tema compartilhado (todas as guias)
   ...
   - Persiste a escolha em localStorage 'cie2_theme' (igual em todas).
     A CHAVE fica com o nome antigo DE PROPOSITO: renomea-la zeraria o tema
     que a crianca ja escolheu. So o ARQUIVO foi renomeado (17/08/2026),
     quando os produtos de Ciencias sairam do repo e o nome 'cie2_' deixou
     de descrever uma infra que e de todas as materias.
   Drop-in: basta <script src="sera_theme.js"></script> em cada guia.
   ============================================================ */
(function(){
  var KEY='cie2_theme';
